           ...
           Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  item['description'], style: Theme.of(context).textTheme.bodyMedium,
maxLines: 2,
